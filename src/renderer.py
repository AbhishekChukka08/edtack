...
def render_html_files(carousel_data: dict, output_dir: str, theme: str = "theme-notebook") -> list[str]:
    """Renders Jinja2 HTML templates with inlined CSS & sketched engineering notebook SVGs."""
    ...
    for slide in carousel_data['slides']:
        ...
        # 2. Ensure cards / cheat sheet / quiz are populated
        ...
        slide_ctx = {
            **slide,
            ...
            "handle": carousel_data.get('handle', 'tech_architecture_daily')
        }
